...
public class CBREngine {
	...
	public static String data_path = new File(System.getProperty("user.dir")).getAbsolutePath();
	private static String projectName = "CBRSystemTicketToRide.prj";
	// name of the central concept 
//	private static String conceptName = Request.getRequestType();
	private static String conceptName = "TicketToRide";
	...
	private static String casebase = "CaseBase";
...
//	}
	 ...
	 * @throws Exception 
	 */	
	public Project loadMyCbrProject() throws Exception{
		Project project =  new Project(new File(data_path, projectName).getAbsolutePath());
